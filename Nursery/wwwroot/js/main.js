...
var Field = /** @class */ (function () {
    function Field(data) {
        ...
        switch (data.Type) {
            ...
            case Type.range:
                templateString =
                    "\n                <label class=\"fg-label\" id=\"" + this.id + "\">" + data.Label + "</label>\n                <input class=\"uk-range\" id=\"" + data.Label.toString() + "\" " + (data.IsRequired ? 'required' : '') + " min=\"" + data.Options[0] + "\" max=\"" + data.Options[1] + "\" type=\"range\" placeholder=\"" + data.Label + "\" pattern=\"" + ((_g = data.validations[0]) === null || _g === void 0 ? void 0 : _g.Regex) + "\">\n                   ";
                break;
            case Type.reset:
                templateString =
